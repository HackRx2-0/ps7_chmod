...
class EnhancePage extends StatefulWidget {
  ...
  EnhancePage({Key? key, required this.realImage}) : super(key: key);
...
class _EnhancePageState extends State<EnhancePage> {
  ...
  Future<void> processImg() async{
    setState(() async {
      widget.realImage =  await ImgProc.threshold(imagesQueue.last, 0, 255,
          ImgProc.cvThreshBINARY + ImgProc.cvThreshOTSU);
    });
  }
